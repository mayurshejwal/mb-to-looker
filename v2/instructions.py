...
DO NOT write files to disk. Instead, output the Looker configuration as a JSON object under the key `translated_look`.
It MUST contain keys: id, name, viz_type, explore, fields (list of view.field), sorts, limit, filters, and confidence ("high"|"low")."""
...
`pruned_look_index` (A dictionary of ONLY the translated cards belonging to this dashboard),
